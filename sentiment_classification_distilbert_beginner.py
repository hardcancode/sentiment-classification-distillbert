# -*- coding: utf-8 -*-
"""sentiment-classification-distilbert-beginner.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1tPINkCd0y0-r--_fvzoV0CNG-M2QAVSz
...
save_path = r'C:\Users\AKHIL\OneDrive\Documents\distilbert-base-uncased'
if not os.path.exists(save_path):
    os.makedirs(save_path)
tokenizer.save_pretrained(save_path)

# Reload it with the huggingface tokenizers library
fast_tokenizer = BertWordPieceTokenizer(r'C:\Users\AKHIL\OneDrive\Documents\distilbert-base-uncased/vocab.txt', lowercase=True)
fast_tokenizer
